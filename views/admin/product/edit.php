      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <input id="price" min="0" class="form-control" type="number" name="price" value="<?php echo $record->price ?? '' ?>" />
              </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="custom-select2 mb-3">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <input id="address" class="form-control" placeholder="example..." name="address" value="<?php echo $record->address ?? '' ?>" />
              </div>
            </div>
          </div>
          <div class="form-group">
              ...
              <?php foreach ($featuresProduct as $key => $value) { ?>
                <div class="col-4">
                  <div class="form-check">
                    <input class="form-check-input" value="<?php echo $key ?>" type="checkbox" name="features[<?php echo $key ?>]" id="features[<?php echo $key ?>]" <?php if (isset($features->$key)) { ?> checked <?php } ?> />
        ...
        <div class="col-12 col-md-3">
          ...
          <div class="form-group">
            ...
            <input id="direction" class="form-control" placeholder="Đông Nam..." name="direction" value="<?php echo $record->direction ?? '' ?>" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input id="floors" min="1" class="form-control" type="number" name="floors" value="<?php echo $record->floors ?? '' ?>" />
          </div>
          <div class="form-group">
            <label for="bedrooms">Số phòng ngủ</label>
            <input id="bedrooms" min="0" class="form-control" type="number" name="bedrooms" value="<?php echo $record->bedrooms ?? '' ?>" />
          </div>
          <div class="form-group">
            <label for="bathrooms">Số phòng tắm</label>
            <input id="bathrooms" min="0" class="form-control" type="number" name="bathrooms" value="<?php echo $record->bathrooms ?? '' ?>" />
          </div>
          <div class="form-group">
            <label for="size">Diện tích</label>
            <input id="size" min="0" class="form-control" type="number" name="size" value="<?php echo $record->size ?? '' ?>" />
          </div>
          <div class="form-group">
            <label for="year_build">Năm xây dựng</label>
            <input id="year_build" class="form-control" type="number" name="year_build" value="<?php echo $record->year_build ?? '' ?>" />
          </div>
        </div>
      </div>
    </div>
